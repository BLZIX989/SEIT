...
| Chainlink projection structure-preservation (categorical/translation claim) | COMPUTED: 7/8 chainlinks directly backed by real dependency edges, remainder self-documented as open gaps, 0 genuine violations | categorical.py |
